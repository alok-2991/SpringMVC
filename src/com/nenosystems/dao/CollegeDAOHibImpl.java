...
import com.nenosystems.exception.DatabaseException;
...
public class CollegeDAOHibImpl implements CollegeDAOInt {
	...
	public CollegeDTO findByName(String name) throws DatabaseException {
		...
		try {
			...
			System.out.println("list size in find by name com.nenosystems.dao" + list.size());
			if (list.size() == 1) {
	...
	public List list(int pageNo, int pageSize) throws DatabaseException {
		...
		try {
			...
			list = c.list();
			System.out.println("Session factory in com.nenosystems.dao :" + sessionFactory);
			System.out.println("list size in com.nenosystems.dao :" + list.size());
		} catch (HibernateException e) {
			System.out.println("Database Exception.." + e);
